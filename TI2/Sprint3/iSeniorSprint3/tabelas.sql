...
insert into faq values (defult, 'Como acessar o canal do iSenior no Youtube?', 'Para acessar nosso canal no youtube, basta você pesquisar "iSenior" na plataforma. Você também pode acessar pelo seguinte link: https://www.youtube.com/channel/UC8gEa4WP7oMFxulS-mov-ng .');
